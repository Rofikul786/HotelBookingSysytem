...
class navbar extends Component {
  ...
  render() {
    ...
    return (
      <nav className="navbar navbar-expand-md navbar-light bg-info shadow-sm  border">
        <div className="container-fluid">
          <Link className="navbar-brand" to="/" style={{ padding: "0.5rem 0" }}>
            {/* <img src="/images/Header_logo.jpeg" alt="EYO" style={{ height: "35px" }} /> */}
            <center><p>Hotel Recommendation System Based On Hybrid </p></center>
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li role="presentation" className="nav-item d-none d-md-block d-lg-block d-xl-block">
                {!user ? (
                  <Link to="/signup" id={styles.button} className="nav-link btn  btn-sm font-weight-bold text-dark ">
